  ...
  return (
    <div className='w-1/2 mx-auto h-max mt-10'>
      <form onSubmit={handleSubmit(onSubmit)} className='mt-6'>
        ...
        <div className='flex justify-between max-h-12 align-middle'>
          <Link className='bg-white-full text-gray-500 py-3 hover:cursor-pointer' to={"/MyGroups"}>Cancel</Link>
          <button type='submit' className='bg-createButton text-white px-4 py-1 rounded-md'>Create</button>
        </div>
