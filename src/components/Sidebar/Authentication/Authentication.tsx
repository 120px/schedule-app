        ...
        <div className='shadow-xl max-w-xl bg-white h-fit mx-auto p-20 mt-12'>
            <div>
                <div className='mb-8 text-center'>
                    ...
                    <span className='text-slate-500'>Please enter your details.</span>
                </div>
                <div className='mb-6'>
                    <div className='mb-6'>
                    ...
                    <div>
                        ...
                        <input type="password" id="first_name" className="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 
